...
export function WalletBalance() {
  ...
  const accounts = [
    { name: "Checking Account", balance: 15420.75, type: "checking", icon: Wallet },
    { name: "Savings Account", balance: 8750.25, type: "savings", icon: Banknote },
  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="bg-gradient-to-r from-primary to-secondary text-primary-foreground">
        ...
        <CardContent>
          <div className="text-3xl font-bold">{showBalance ? `$${totalBalance.toLocaleString()}` : "••••••"}</div>
